                        ...
                        <tbody>
                            ...
                            {alunos.map((item, i) =>
                                <tr className={i % 2 === 0 ? "int" : ""}>
                                    ...
                                    <td> {item.nm_turma} </td>
                                    <td> {item.nm_curso} </td>
                                    <td className={"a"}> <button onClick={() => editar(item)}> <img src="/assets/images/button-editar.svg" alt=""/> </button> </td>
                                    <td className={"a"}> <button onClick={() => remover(item.id_matricula)}> <img src="/assets/images/button-remover.svg" alt=""/> </button> </td>
                                </tr>
                            )}
